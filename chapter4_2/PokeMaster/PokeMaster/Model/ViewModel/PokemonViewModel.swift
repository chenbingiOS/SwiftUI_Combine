...
struct PokemonViewModel: Identifiable, Codable {
    ...
    var types: [Type] {
        pokemon.types.sorted { $0.slot < $1.slot }.map { Type(pokemonType: $0)}
    }
    ...
    var descriptionText: String { species.flavorTextEngries.CN.newLineRemoved }
    var descriptionTextEN: String { species.flavorTextEngries.EN.newLineRemoved }
}
